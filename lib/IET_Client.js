...
if (clientId) {
	...
	IET_Client.FuelAuthClient.getAccessToken(IET_Client.FuelAuthClient, (err,success)=> {
		if(err){
			console.log('err :', err);
		}else{
			console.log('success :', success);
			console.log('IET_CLIENT.FuelAuthClient :', IET_Client.FuelAuthClient);
			// console.log('object :', object);
		}
	}); //second param here can be a callback. or you change this to use promises like fuel-rest.
}
